...
if (isset($_POST["categoryhome"])) {
	...
	echo '
        <li class="team"><a href="book_test_drive.php">Book Test Drive</a></li>
        <li class="team"><a href="financial_assistance.php">Financial Assistance</a></li>
        <li class="team"><a href="contactus.php">Contact Us</a></li>';
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>$pro_price<del class='product-old-price'>₹990000.00</del></h4>
									</div></a>
								</div>
