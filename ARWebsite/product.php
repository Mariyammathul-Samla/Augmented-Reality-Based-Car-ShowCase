...
<div class="section main main-raised">
    ...
    <div class="col-md-5">
        <div class="product-details">
            ...
            <div>
                <h3 class="product-price">₹' . $row['product_price'] . '<del class="product-old-price">₹990000.00</del></h3>
            ...
            <div class="add-to-cart">
                ...
                <div class="btn-group" style="margin-left: 25px; margin-top: 15px">
					...
					if ($row['product_id'] == 87) {
						echo '
						<div class="btn-group" style="margin-left: 25px; margin-top: 15px;">
							<a href="https://drive.google.com/file/d/1alg8xXP8lUm-lk7AWSDS49WWLX1ulo_q/view?usp=sharing" class="custom-link" target="_blank">
							<button class="add-to-cart-btn"><i class="fa fa-camera"></i>View in space </button>
							</a>
						</div>';
				}
				else{
						...
						<div id="tab1" class="tab-pane fade in active">
							<div class="row">
								<div class="col-md-12">
									...
									include 'db.php';
									$product_id = $_GET['p'];
									$product_query = "SELECT product_desc FROM products WHERE product_id='$product_id'";
									$run_query = mysqli_query($con, $product_query);
									$row = mysqli_fetch_array($run_query);
